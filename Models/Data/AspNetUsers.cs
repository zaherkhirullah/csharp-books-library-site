namespace ZHYR_Library.Models.Data
{
    ...
    public partial class AspNetUsers
    {
        ...
        [Display(Name = "file"), StringLength(256)]
        public string avatar { get; set; }
        [Display(Name = "cover"), StringLength(256)]
        public string cover { get; set; }
        [Display(Name = "Created date"), DataType(DataType.DateTime)]
        public DateTime Created_at { get; set; }
        [Display(Name = "Updated date"), DataType(DataType.DateTime)]
        public DateTime? Updated_at { get; set; }
        [Display(Name = "Deleted date"), DataType(DataType.DateTime)]
